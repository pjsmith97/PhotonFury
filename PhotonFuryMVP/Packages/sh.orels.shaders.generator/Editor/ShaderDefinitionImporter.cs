...
{
    [UnityEditor.AssetImporters.ScriptedImporter(1, "orlshader")]
    public class ShaderDefinitionImporter : UnityEditor.AssetImporters.ScriptedImporter
    {
        ...
        private void RegisterDependencies(List<string> dependencyPaths, UnityEditor.AssetImporters.AssetImportContext ctx)
        {
            var workingFolder = ctx.assetPath.Substring(0, ctx.assetPath.LastIndexOf("/", StringComparison.InvariantCulture));
